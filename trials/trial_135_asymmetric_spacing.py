...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_135_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial135.json")
...
# Recruiters:
# Left cluster at standard distance, phase ~0.48
left_cluster = [
...
# Right cluster brought closer to center, phase ~0.52
right_cluster = [
    {'x': 2.0, 'y': -1.0, 'phase': 0.51},
    {'x': 2.0, 'y':  0.0, 'phase': 0.52},
    {'x': 2.0, 'y':  1.0, 'phase': 0.53}
]
