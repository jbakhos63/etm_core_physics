...
# Dual identities: same ancestry, same spin
...
for t in range(ticks):
    for identity in [identity_A, identity_B]:
        ...
        identity["position"] += 0.032  # Move forward
...
with open("../results/trial_199b_same_spin_ancestry_exclusion_summary.json", "w") as f:
