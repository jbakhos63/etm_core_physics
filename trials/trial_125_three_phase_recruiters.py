...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_125_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial125.json")
...
# Recruiters: phase 0.25 (y = -1), 0.5 (y = 0), 0.75 (y = +1), all at x = -3
recruiters = [
    {'x': -3.0, 'y': -1.0, 'phase': 0.25},
    {'x': -3.0, 'y':  0.0, 'phase': 0.50},
