...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_181_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial181.json")
...
for tick in range(TICK_LIMIT):
    ...
    # Phase-tuned recruiters (band structure)
