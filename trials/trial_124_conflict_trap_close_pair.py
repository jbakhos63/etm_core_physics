...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_124_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial124.json")
...
# Recruiters: close together, but opposing phase
recruiters = [
    {'x': -3.0, 'y': -0.5, 'phase': 0.25},
    {'x': -3.0, 'y':  0.5, 'phase': 0.75}
]
