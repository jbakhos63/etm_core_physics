"""
Trial 002: Echo Propagation in 3x3 Grid

Goal:
- Central rotor node (1,1) emits ancestry + phase echoes
- Recruiter nodes track memory and support score over 10 ticks
- Log final recruiter summaries
"""
...
for rec in recruiters.values():
    rec.export_summary(f"../results/{rec.node_id}_trial002.json")
