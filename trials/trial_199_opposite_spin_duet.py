...
# Dual identities: A and B (opposite spin)
identity_A = {"id": "A", "ancestry": "rotorA", "spin": "up", "phase": 0.0, "position": 9.0}
identity_B = {"id": "B", "ancestry": "rotorB", "spin": "down", "phase": 0.0, "position": 15.0}
...
with open("../results/trial_199_opposite_spin_duet_summary.json", "w") as f:
