...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_136_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial136.json")
...
# Recruiters:
# Left cluster (farther, phase-aligned)
left_cluster = [
...
# Right cluster (closer, phase-mismatched)
right_cluster = [
    {'x': 2.0, 'y': -1.0, 'phase': 0.60},
    {'x': 2.0, 'y':  0.0, 'phase': 0.61},
    {'x': 2.0, 'y':  1.0, 'phase': 0.62}
]
