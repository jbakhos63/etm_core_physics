...
# trial_115_return_delay_vs_echo_strength.py

"""
Trial 115: Return Delay vs Echo Strength Curve

Goal:
- Determine how modular return delay varies with echo reinforcement strength, with fixed decay.
- Maps ETM analog of gravitational acceleration based on rhythm field depth.
"""
...
STRENGTHS = [0.010, 0.015, 0.018, 0.020, 0.025, 0.030]
TOTAL_TICKS = 100
ANCESTRY = "echo_strength_test"
...
with open(os.path.join(output_dir, "trial_115_summary.json"), "w") as f:
    json.dump({
        "trial": "115",
        "drop_tick": DROP_TICK,
...
with open(os.path.join(output_dir, "transition_log_trial115.json"), "w") as f:
    json.dump(results, f, indent=2)

print("✓ Trial 115 complete. Results written to '../results/' folder.")
