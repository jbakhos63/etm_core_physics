...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_150_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial150.json")
...
# Two identities: same ancestry, identical phase and descent path
identities = [
    {
        'x': 6.5,
        'y': 1.0,
