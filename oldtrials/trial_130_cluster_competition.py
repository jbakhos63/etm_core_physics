...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_130_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial130.json")
...
# Left cluster (better phase match): phase ~0.48
left_cluster = [
...
# Right cluster (weaker phase match): phase ~0.52
right_cluster = [
