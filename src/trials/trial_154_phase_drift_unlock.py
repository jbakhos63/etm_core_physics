...
PHASE_INCREMENT_DRIFT = 0.002  # Increase after tick 50 to simulate drift
DRIFT_TICK = 50
LOCK_THRESHOLD = 0.1
LOCK_TOLERANCE = 0.05
...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_154_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial154.json")
