...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_183_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial183.json")

def phase_distance(a, b):
    return min(abs(a - b), 1 - abs(a - b))

# Two identities, with slight phase ancestry offset
identities = [
