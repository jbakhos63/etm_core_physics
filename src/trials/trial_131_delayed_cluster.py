...
RIGHT_CLUSTER_ACTIVATION_TICK = 30

# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_131_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial131.json")
...
# Left recruiter cluster (active from start)
left_cluster = [
...
# Right recruiter cluster (activated at tick 30)
right_cluster = [
...
for tick in range(TICK_LIMIT):
    ...
    # Activate recruiters
    recruiters = left_cluster.copy()
    if tick >= RIGHT_CLUSTER_ACTIVATION_TICK:
        recruiters += right_cluster
    ...
    transition_log.append({
        ...
        'support': support,
        'right_cluster_active': tick >= RIGHT_CLUSTER_ACTIVATION_TICK
    })
