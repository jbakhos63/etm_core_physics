...
# trial_058_module_Z_identity_fusion_test.py

"""
Trial 058: Modular Identity Fusion Test (Corrected)

Goal:
- Drop four identities (2 protons, 2 neutrons) into Module Z rhythm basin
- Let them stabilize recruiter rhythm
- Remove identities and check whether rhythm persists (echo memory)
"""
...
with open(os.path.join(output_dir, "trial_058_summary.json"), "w") as f:
    json.dump({
        "trial": "058",
        "drop_tick": DROP_TICK,
...
with open(os.path.join(output_dir, "transition_log_trial058.json"), "w") as f:
    json.dump(tick_log, f, indent=2)

print("✓ Trial 058 complete. Results written to '../results/' folder.")
