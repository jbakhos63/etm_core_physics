...
# Output paths
RESULTS_DIR = "../results"
SUMMARY_FILENAME = os.path.join(RESULTS_DIR, "trial_134_summary.json")
TRANSITION_LOG_FILENAME = os.path.join(RESULTS_DIR, "transition_log_trial134.json")
...
# Recruiters:
# - Two opposing clusters of identical strength and symmetric spacing
# - One centered around phase 0.48 (left), one around 0.52 (right)
left_cluster = [
    {'x': -2.5, 'y': -1.0, 'phase': 0.47},
    {'x': -3.0, 'y':  0.0, 'phase': 0.48},
    {'x': -2.5, 'y':  1.0, 'phase': 0.49}
]

right_cluster = [
    {'x': 2.5, 'y': -1.0, 'phase': 0.51},
    {'x': 3.0, 'y':  0.0, 'phase': 0.52},
    {'x': 2.5, 'y':  1.0, 'phase': 0.53}
]

recruiters = left_cluster + right_cluster
